...
spark-submit --class ca.uwaterloo.cs651.project.CoreNLP --driver-memory 6G --executor-memory 6G target/project-1.0.jar -input simpledata -output output -functionality relation
