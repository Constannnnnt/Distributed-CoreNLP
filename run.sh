...
spark-submit --class ca.uwaterloo.cs651.project.CoreNLP --driver-memory 2G --executor-memory 2G target/project-1.0.jar -input simpledata -output output -functionality pos
